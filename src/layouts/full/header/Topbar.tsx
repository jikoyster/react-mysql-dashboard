...
*/
import terrasync_logo from "/src/assets/images/logos/logo.png";
...
const Topbar = () => {
    ...
    */
    return (
        <div className="py-[15px] px-6 z-40 sticky top-0 bg-[linear-gradient(90deg,_#cccccc_0%,_#ffffff_100%)]">
